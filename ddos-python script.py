import random #menghasilkan angka acak, memilih elemen acak dari sebuah list, dan melakukan berbagai operasi acak
import ipaddress #membuat, memanipulasi, dan memeriksa alamat IP
from scapy.all import IP, TCP, send #membuat, mengirim, menangkap, dan memanipulasi paket jaringan.
from concurrent.futures import ThreadPoolExecutor #menjalankan panggilan asinkron menggunakan thread pool atau process pool
import paramiko  #Mengeksekusi perintah di remote server
